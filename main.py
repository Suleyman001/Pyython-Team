...
# Base URL for Gradus
ARCHIVE_URL = "https://gradus.kefo.hu/archive/"
...
def process_pdf(pdf_url):
    ...
    page_numbers = [i + 1 for i, page in enumerate(reader.pages)]
...
def scrape_gradus():
    ...
    for link in soup.find_all("a", href=True):
        if link["href"].endswith(".pdf"):
            article_data = {}
            pdf_url = link["href"]
            article_data["Filename"] = pdf_url.split("/")[-1]
            ...
            filename_parts = article_data["Filename"].split("_")
